...
function bindHomeLogin(){
 const button=$('[data-action="home-login"]');
 if(button)button.onclick=async()=>{await api('/logout','POST',{});auth=await api('/session');current=null;history.replaceState(null,'',location.pathname);login();};
}
