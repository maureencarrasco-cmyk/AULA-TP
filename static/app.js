...
function isAppHashRoute(hash){
 ...
 return hash==='courses'||hash==='teacher'||/^course\/\d+$/.test(hash)||/^module\/\d+(?:\/[1-5])?$/.test(hash)||/^editor\/\d+$/.test(hash)||/^teacher\/[a-z-]+$/.test(hash);
}
...
function contextPanel(){
 ...
 return workZone(`${panelTitle(1,'Conoce el contexto y activa tus conocimientos previos.',typeof cargaLabel==='function'?cargaLabel(1,'Carga x5'):'Carga x5')}
