...
from tourism_catalog import OFFICIAL, draft_modules, install_tourism_course, install_tourism_draft
...
class TourismCatalogTests(unittest.TestCase):
    ...
    def test_unpublished_install_is_idempotent(self):
        ...
        con.executescript('''
            ...
            INSERT INTO courses(id,title) VALUES(1,'Servicios de Turismo');
        ''')
    ...
    def test_complete_course_is_publishable_and_idempotent(self):
        ...
        for row in rows:
            ...
            self.assertEqual('turismo-mineduc-v1', content['version'])
            self.assertEqual([], publication_gaps(content, 'Servicios de Turismo'))
        con.close()
