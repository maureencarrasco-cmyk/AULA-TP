...
assert.equal(c.stationHeaderArt(1,c.courses[0]),'/static/themes/workshop.png');
assert.equal(c.stationHeaderArt(2,c.courses[0]),plano);
assert.equal(c.stationHeaderArt(3,c.courses[0]),plano);
assert.equal(c.stationHeaderArt(4,c.courses[0]),'/static/estacion4-evaluacion-climatizacion.png?v=1');
assert.equal(c.stationHeaderArt(5,c.courses[0]),'/static/themes/estacion5-hero-v2.png?v=1');
