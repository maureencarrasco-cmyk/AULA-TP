...
from merchant_crew_catalog import OFFICIAL, draft_modules, install_merchant_crew_course, install_merchant_crew_draft
from pedagogy import publication_gaps


class MerchantCrewCatalogTests(unittest.TestCase):
    ...
    def test_unpublished_install_is_idempotent(self):
        ...
        con.executescript('''
            ...
            INSERT INTO courses(id,title) VALUES(1,'Tripulación de Naves Mercantes y Especiales');
        ''')
    ...
    def test_complete_course_is_publishable_and_idempotent(self):
        ...
        for row in rows:
            ...
            self.assertEqual('tripulacion-naves-mercantes-especiales-mineduc-v1', content['version'])
            self.assertEqual([], publication_gaps(content, 'Tripulación de Naves Mercantes y Especiales'))
        con.close()
