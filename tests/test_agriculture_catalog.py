...
from agriculture_catalog import OFFICIAL, draft_modules, install_agriculture_courses, install_agriculture_drafts
...
class AgricultureCatalogTests(unittest.TestCase):
    ...
    def test_three_mentions_are_publishable_and_idempotent(self):
        ...
        install_agriculture_courses(con)
        for _, title, _, _ in __import__('agriculture_catalog').TRACKS:
