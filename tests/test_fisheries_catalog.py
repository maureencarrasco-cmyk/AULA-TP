...
from fisheries_catalog import OFFICIAL, draft_modules, install_fisheries_course, install_fisheries_draft
from pedagogy import publication_gaps


class FisheriesCatalogTests(unittest.TestCase):
    ...
    def test_unpublished_install_is_idempotent(self):
        ...
        con.executescript('''
            ...
            INSERT INTO courses(id,title) VALUES(1,'Pesquería');
        ''')
    ...
    def test_complete_course_is_publishable_and_idempotent(self):
        ...
        for row in rows:
            ...
            self.assertEqual('pesqueria-mineduc-v1', content['version'])
            self.assertEqual([], publication_gaps(content, 'Pesquería'))
        con.close()
