...
from sanitary_catalog import OFFICIAL, draft_modules, install_sanitary_course, install_sanitary_draft


class SanitaryCatalogTests(unittest.TestCase):
    ...
    def test_unpublished_install_is_idempotent(self):
        ...
        con.executescript('''
            ...
            INSERT INTO courses(id,title) VALUES(1,'Instalaciones Sanitarias');
        ''')
    ...
    def test_complete_course_is_publishable_and_idempotent(self):
        ...
        for row in rows:
            ...
            self.assertEqual('sanitarias-mineduc-v1', content['version'])
            self.assertEqual([], publication_gaps(content, 'Instalaciones Sanitarias'))
        con.close()
