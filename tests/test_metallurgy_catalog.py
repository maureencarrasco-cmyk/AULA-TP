...
from metallurgy_catalog import OFFICIAL, draft_modules, install_metallurgy_course, install_metallurgy_draft
from pedagogy import publication_gaps


class MetallurgyCatalogTests(unittest.TestCase):
    ...
    def test_unpublished_install_is_idempotent(self):
        ...
        con.executescript('''
            ...
            INSERT INTO courses(id,title) VALUES(1,'Metalurgia Extractiva');
        ''')
    ...
    def test_complete_course_is_publishable_and_idempotent(self):
        ...
        for row in rows:
            ...
            self.assertEqual('metalurgia-extractiva-mineduc-v1', content['version'])
            self.assertEqual([], publication_gaps(content, 'Metalurgia Extractiva'))
        con.close()
