...
from telecom_catalog import OFFICIAL, draft_modules, install_telecom_course, install_telecom_draft
from pedagogy import publication_gaps


class TelecomCatalogTests(unittest.TestCase):
    ...
    def test_unpublished_install_is_idempotent(self):
        ...
        con.executescript('''
            ...
            INSERT INTO courses(id,title) VALUES(1,'Telecomunicaciones');
        ''')
    ...
    def test_complete_course_is_publishable_and_idempotent(self):
        ...
        for row in rows:
            ...
            self.assertEqual('telecomunicaciones-mineduc-v1', content['version'])
            self.assertEqual([], publication_gaps(content, 'Telecomunicaciones'))
        con.close()
