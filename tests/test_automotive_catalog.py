...
from automotive_catalog import OFFICIAL, draft_modules, install_automotive_course, install_automotive_draft
from pedagogy import publication_gaps


class AutomotiveCatalogTests(unittest.TestCase):
    ...
    def test_unpublished_install_is_idempotent(self):
        ...
        con.executescript('''
            ...
            INSERT INTO courses(id,title) VALUES(1,'Mecánica Automotriz');
        ''')
    ...
    def test_complete_course_is_publishable_and_idempotent(self):
        ...
        for row in rows:
            ...
            self.assertEqual('mecanica-automotriz-mineduc-v1', content['version'])
            self.assertEqual([], publication_gaps(content, 'Mecánica Automotriz'))
        con.close()
