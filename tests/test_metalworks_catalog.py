...
from metalworks_catalog import OFFICIAL, draft_modules, install_metalworks_course, install_metalworks_draft
from pedagogy import publication_gaps


class MetalworksCatalogTests(unittest.TestCase):
    ...
    def test_unpublished_install_is_idempotent(self):
        ...
        con.executescript('''
            ...
            INSERT INTO courses(id,title) VALUES(1,'Construcciones Metálicas');
        ''')
    ...
    def test_complete_course_is_publishable_and_idempotent(self):
        ...
        for row in rows:
            ...
            self.assertEqual('construcciones-metalicas-mineduc-v1', content['version'])
            self.assertEqual([], publication_gaps(content, 'Construcciones Metálicas'))
        con.close()
