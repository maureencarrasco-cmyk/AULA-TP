...
def install_early_childhood_course(con):
    install_course(con, 'Atención de Párvulos', draft_modules(),
                   'atencion-parvulos-mineduc-draft-v1',
                   'atencion-parvulos-mineduc-v1')
