...
def install_automotive_course(con):
    install_course(con, 'Mecánica Automotriz', draft_modules(),
                   'mecanica-automotriz-mineduc-draft-v1',
                   'mecanica-automotriz-mineduc-v1')
